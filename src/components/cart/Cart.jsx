...
const Cart = () => {
  ...
  return (
    <div className='cart_section'>
        ...
        {
        cart.map((item) => {
          return <CartItem id={item.id} subtitle = {item.subtitle} name={item.name} img={item.images} price = {item.price} amount={item.amount} />
        })
        }
        </div>
            ...
            <div className="summary_section">
             ...
             <NavLink className="navlink" to="/sale"> <button>Continue Shopping</button></NavLink>
              </div>
            </div>
