      ...
      <ul className="header__items">
        <li className="first__item">
          ...
          <div className="sub__menu">
            <ul>
              <div className="sub__menu_heading">
                <h3>News and Featured</h3>
        ...
        <NavLink className="navlink" to="/snkr">
          <li>SNKRS</li>
        </NavLink>
      </ul>
        ...
        <div className="header__icons">
          ...
          <div>
            <NavLink className="navlink" to="/cart">
              <PiSuitcaseSimpleThin className="cart_icon" />
            </NavLink>
            <div className="total_item_icon">{total_item}</div>
          </div>
          ...
          <div className={showMenu ? "slide-out-menu" : "slide-out-hide"}>
            {showMenu ? (
              <ul className="slide-out-list">
                ...
                <NavLink className="navlink" to="/sale">
                  <li onClick={() => setShowMenu(!showMenu)}>Sale</li>
                </NavLink>
                <NavLink className="navlink" to="/snkr">
                  {" "}
                  <li onClick={() => setShowMenu(!showMenu)}>SNKRS</li>
                </NavLink>
              </ul>
            ) : (
              ""
